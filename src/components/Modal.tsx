...
const Modal: React.FC<ModalProps> = ({
  ...
  return isVisible ? (
    <div
      onClick={onClick}
      className=' bg-transparent absolute w-screen h-screen backdrop-blur-sm left-0 top-0 grid place-items-center z-50'
    >
      <dialog
        className={cn(modalVariants({ variant, className }), "w-fit")}
